...
/*!***********************!*\
  !*** ./src/js/app.js ***!
  \***********************/
/*! exports provided: note, storage, titleField, textField, notebookField, selectImportance */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"note\", function() { return note; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"storage\", function() { return storage; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"titleField\", function() { return titleField; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"textField\", function() { return textField; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"notebookField\", function() { return notebookField; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"selectImportance\", function() { return selectImportance; });\n/* harmony import */ var _note_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./note.js */ \"./src/js/note.js\");\n/* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage.js */ \"./src/js/storage.js\");\n\r\n\r\n\r\n// Variables\r\nconst titleField = document.querySelector(\"#note-title\"),\r\n\ttextField = document.querySelector(\"#note-content\"),\r\n\taddNew = document.querySelector(\"#note-add\"),\r\n\tnotebookField = document.querySelector(\"#notes-container\"),\r\n\tselectImportance = document.querySelector(\"#select-importance\");\r\n\r\nconst note = new _note_js__WEBPACK_IMPORTED_MODULE_0__[\"Note\"]();\r\nconst storage = new _storage_js__WEBPACK_IMPORTED_MODULE_1__[\"Storage\"]();\r\n\r\n// Listeners\r\naddNew.addEventListener(\"click\", note.addNote);\r\nnotebookField.addEventListener(\"click\", note.removeNote);\r\ndocument.addEventListener(\"DOMContentLoaded\", storage.totalStorageOnLoad);\r\n\r\n\r\n\n\n//# sourceURL=webpack:///./src/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Note\", function() { return Note; });\n/* harmony import */ var _app_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.js */ \"./src/js/app.js\");\n\n\nclass Note {\n\taddNote() {\n\t\tconst title = _app_js__WEBPACK_IMPORTED_MODULE_0__[\"titleField\"].value,\n\t\t\tnote = _app_js__WEBPACK_IMPORTED_MODULE_0__[\"textField\"].value,\n\t\t\timportance = _app_js__WEBPACK_IMPORTED_MODULE_0__[\"selectImportance\"].value,\n\t\t\tdateID = Date.now();\n\n\t\tif (note != \"\" && title != \"\" && importance != \"\") {\n\t\t\tconst newNote = `\n\t\t\t\t<div class=\"added-note added-note--${importance}\" id=\"${dateID}\">\n\t\t\t\t\t<h3 class=\"added-note__heading\">${title}</h3>\n\t\t\t\t\t<p class=\"added-note__content\">${note}</p>\n\t\t\t\t\t<span class=\"added-note__remove\">&#10007;</span>\n\t\t\t\t</div>\n\t\t\t`;\n\n\t\t\t_app_js__WEBPACK_IMPORTED_MODULE_0__[\"notebookField\"].innerHTML += newNote;\n\t\t\t_app_js__WEBPACK_IMPORTED_MODULE_0__[\"storage\"].addNoteToTheStorage(title, note, importance, dateID);\n\t\t} else {\n\t\t\talert(\"You have to fill title and text fields!\");\n\t\t}\n\t}\n\n\tremoveNote(e) {\n\t\tif (e.target.classList.contains(\"added-note__remove\")) {\n\t\t\tconst r = confirm(\"Are you sure?\");\n\n\t\t\tif (r === true) {\n\t\t\t\tconst note = e.target.parentElement,\n\t\t\t\t\tdataID = Number(note.id);\n\n\t\t\t\tnote.remove();\n\t\t\t\t_app_js__WEBPACK_IMPORTED_MODULE_0__[\"storage\"].removeFromLocalStorage(dataID);\n\t\t\t}\n\t\t}\n\t}\n}\n\n\n\n\n//# sourceURL=webpack:///./src/js/note.js?");
